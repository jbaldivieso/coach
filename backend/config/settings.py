...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-=9gs$@n59uzngb6rwuc=w!_a@(9x#cntue1_85n8l@3m@-tp9!",
)
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR / "templates",
            BASE_DIR.parent / "frontend" / "dist",  # Vue SPA build output
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# Include frontend build output in static files (only if it exists)
...
# Session settings - 2 weeks duration
